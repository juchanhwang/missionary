 ...
 *
 * mockup 토큰:
 * - 카드: `shadow-xl ring-1 ring-blue-300 rotate-[1.5deg] bg-white`
 * - drag label: `bg-blue-50 text-blue-600 border border-blue-200 rounded-md px-2 py-0.5 text-[11px] font-semibold`
 *
...
export function DragOverlayCard({
  ...
  return (
    <div
      ...
      className="relative flex items-start gap-2 bg-white border border-blue-200 rounded-lg px-2.5 py-2 shadow-xl ring-1 ring-blue-300 rotate-[1.5deg] w-[200px]"
    >
      {overLabel !== null && (
        <span
          data-testid="drag-overlay-label"
          className="absolute -top-2.5 left-1/2 -translate-x-1/2 inline-flex items-center bg-blue-50 text-blue-600 border border-blue-200 rounded-md px-2 py-0.5 text-[11px] font-semibold whitespace-nowrap shadow-sm"
        >
          → {overLabel}
        </span>
      )}
