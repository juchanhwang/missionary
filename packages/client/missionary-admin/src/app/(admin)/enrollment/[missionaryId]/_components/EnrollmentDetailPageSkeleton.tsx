export function EnrollmentDetailPageSkeleton() {
  return (
      ...
      <div className="flex flex-col flex-1 p-8 gap-5 min-h-0">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="h-8 w-[106px] animate-pulse rounded-lg bg-gray-100" />
          </div>

          {/* 타이틀 + 배지 */}
          <div className="flex items-center gap-2.5">
            <div className="h-7 w-40 animate-pulse rounded-lg bg-gray-100" />
            <div className="h-[22px] w-10 animate-pulse rounded-md bg-gray-100" />
            <div className="h-[22px] w-16 animate-pulse rounded-md bg-gray-100" />
          </div>
