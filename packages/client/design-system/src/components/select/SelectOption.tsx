...
export const SelectOption = ({
  ...
  return (
    <li
      ref={ref}
      className={cn(
        'relative flex cursor-pointer select-none items-center px-4 py-2.5 text-sm transition-colors hover:bg-gray-50 active:bg-gray-100',
        'data-[selected=true]:bg-gray-50 data-[selected=true]:text-gray-900 data-[selected=true]:font-medium',
        className,
      )}
